...
from src.megacompile.schemas import CreateMegaCompiles, ShowDateTimes
...
@mega_compile_router.get('/machine/{machine_id}/name/{name_id}')
async def get_mega_compiles(machine_id: int, name_id: int):
    return "hello world"
